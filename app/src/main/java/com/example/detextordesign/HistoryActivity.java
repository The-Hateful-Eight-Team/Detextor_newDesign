...
// Handle navigation view item clicks here.
        switch (item.getItemId()) {
            ...
            case R.id.fav:
                Intent intent3 = new Intent(HistoryActivity.this, FavoritesActivity.class);
            ...
            case R.id.his:
                ...
                return true;
            case R.id.about:
                Intent intent5 = new Intent(HistoryActivity.this, AboutActivity.class);
        ...
        okHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(@NotNull Call call, @NotNull IOException e) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(HistoryActivity.this, "Something went wrong:" + " " + e.getMessage(), Toast.LENGTH_SHORT).show();
            ...
            public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            Toast.makeText(HistoryActivity.this, "Recognition is done", Toast.LENGTH_LONG).show();
                            String answer = Objects.requireNonNull(response.body()).string();
                            System.out.println("========================================ANSWER===========================================");
                            System.out.println(answer);
                            res = answer;
                            Intent intent6 = new Intent(HistoryActivity.this, TextActivity.class);
